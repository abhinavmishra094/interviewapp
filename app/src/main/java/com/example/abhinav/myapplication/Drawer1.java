...
public class Drawer1 extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Fragment regist = new Regist();
        FragmentTransaction fragmentTransaction = getSupportFragmentManager().beginTransaction();
        fragmentTransaction.replace(R.id.fr1, regist, "abc");
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (id)
        {
            ...
            case R.id.show:
                ...
                fragmentTransaction1.replace(R.id.fr1, show, "abc");
                fragmentTransaction1.addToBackStack("abc");
